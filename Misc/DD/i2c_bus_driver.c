...
** Set SDA -> Set SCL - > Delay - > clear SDA -> Delay -> clear SCL-> Delay 
**      ______              set SDA
**            \
**  SDA        \_____       clear SDA
**              :
...
** clear SDA -> Delay -> set SCL -> Delay -> set SDA - > Delay -> clear SCL
**                _____    set SDA   (High)
**               /
**  SDA  _______/          clear SDA (Low)
**              :
**              :
**            __:______    clear SCL (High)
**  SCL      /
**       ___/              set SCL   (Low)
*/
...
static int __init hwm_driver_init(void)
{
  ...
  ret = i2c_add_numbered_adapter(&hwm_i2c_adapter);
